...
class Diffuser(nn.Module):
    def __init__(self, image_size, in_channels, time_embedding_dim=256, timesteps=1000, base_dim=32,
        ...
        betas = self._linear_variance_schedule(timesteps)  # or self._linear_variance_schedule(timesteps)
        alphas = 1. - betas
    ...
    def forward(self, x, noise):
        ...
        pred_noise = self.model(x_t, t)  # predict noise variable epsilon
    ...
    def _reverse_diffusion_with_clip(self, x_t: Tensor, t: Tensor, noise: Tensor) -> Tensor:
        ...
        '''
        pred = self.model(x_t, t)  # predict noise
